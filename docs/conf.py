...
latex_documents = [
    (master_doc, 'pyIMS.tex', u'pyIMS Documentation',
...
man_pages = [
    (master_doc, 'pyims', u'pyIMS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyIMS', u'pyMS Documentation',
     author, 'pyIMS', 'One line description of project.',
     'Miscellaneous'),
]
